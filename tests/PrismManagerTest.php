...
it('can resolve Anthropic', function (): void {
    ...
    expect($manager->resolve(Anthropic::class))->toBeInstanceOf(Anthropic::class);
...
it('can resolve Ollama', function (): void {
    ...
    expect($manager->resolve(Ollama::class))->toBeInstanceOf(Ollama::class);
...
it('can resolve OpenAI', function (): void {
    ...
    expect($manager->resolve(OpenAI::class))->toBeInstanceOf(OpenAI::class);
