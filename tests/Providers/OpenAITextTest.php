...
describe('Image support', function (): void {
    ...
    it('can send images from base64', function (): void {
        FixtureResponse::fakeResponseSequence('v1/chat/completions', 'openai/text-image-from-base64');
    ...
    it('can send images from url', function (): void {
        FixtureResponse::fakeResponseSequence('v1/chat/completions', 'openai/text-image-from-url');
